...
#[allow(non_snake_case, reason = "schema field names are preserved")]
#[derive(Debug, Clone, PartialEq)]
pub struct ItemAttInfoRecord {
    pub attribute_id: u32,
    pub power_value: u32,
    pub category: u32,
}

impl ItemAttInfoRecord {
    #[allow(non_snake_case, reason = "schema field names are preserved")]
    #[allow(clippy::too_many_lines, reason = "schema methods follow field order")]
    pub fn parse(buf: &[u8], offset: &mut usize) -> ::std::result::Result<Self, Error> {
        let attribute_id = u32::from_le_bytes(self::read_array::<4>(buf, offset)?);
        let power_value = u32::from_le_bytes(self::read_array::<4>(buf, offset)?);
        let category = u32::from_le_bytes(self::read_array::<4>(buf, offset)?);
        Ok(Self {
            attribute_id,
            power_value,
            category,
...
impl ItemAttInfoRecord {
    ...
    pub fn to_bytes(&self) -> ::std::result::Result<::std::vec::Vec<u8>, Error> {
        let mut buf = ::std::vec::Vec::new();
        let value = &self.attribute_id;
        buf.extend_from_slice(&(*value).to_le_bytes());
        let value = &self.power_value;
        buf.extend_from_slice(&(*value).to_le_bytes());
...
impl ItemAttInfoRecord {
    ...
    pub fn to_json(&self) -> ::std::string::String {
        let mut json = ::std::string::String::from("{");
        write_json_string(&mut json, "attribute_id");
        json.push(':');
        let value = &self.attribute_id;
        json.push_str(&value.to_string());
        json.push(',');
        write_json_string(&mut json, "power_value");
        json.push(':');
        let value = &self.power_value;
        json.push_str(&value.to_string());
        json.push(',');
...
pub struct File {
    ...
    pub records: ::std::vec::Vec<ItemAttInfoRecord>,
    pub footer: [u8; 64],
}
...
impl File {
    ...
    pub fn parse(buf: &[u8], offset: &mut usize) -> ::std::result::Result<Self, Error> {
        ...
        let records = {
            ...
            for _ in 0..count {
                values.push(ItemAttInfoRecord::parse(buf, offset)?);
            }
            values
        };
        let footer = {
