...
#[allow(non_snake_case, reason = "schema field names are preserved")]
#[derive(Debug, Clone, PartialEq)]
pub struct AbilityByJobRecord {
    pub job_id: u32,
    pub ability_slots: [i32; 5],
}

impl AbilityByJobRecord {
    #[allow(non_snake_case, reason = "schema field names are preserved")]
    #[allow(clippy::too_many_lines, reason = "schema methods follow field order")]
    pub fn parse(buf: &[u8], offset: &mut usize) -> ::std::result::Result<Self, Error> {
...
impl AbilityByJobRecord {
    ...
    pub fn to_json(&self) -> ::std::string::String {
        ...
        json.push_str(&value.to_string());
        json.push(',');
        write_json_string(&mut json, "ability_slots");
        json.push(':');
        let value = &self.ability_slots;
        json.push('[');
...
pub struct File {
    ...
    pub records: ::std::vec::Vec<AbilityByJobRecord>,
    pub footer: [u8; 64],
}
...
impl File {
    ...
    pub fn parse(buf: &[u8], offset: &mut usize) -> ::std::result::Result<Self, Error> {
        ...
        let records = {
            ...
            for _ in 0..count {
                values.push(AbilityByJobRecord::parse(buf, offset)?);
            }
            values
        };
        let footer = {
